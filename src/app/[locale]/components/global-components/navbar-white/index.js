...
const NavbarWhite = ({
  ...
  return (
    <div className="text-xl antialiased fixed w-screen h-28 flex justify-between items-center px-10 lg:px-16 py-4 bg-gray-200 top-0 left-0 z-50 border-t-4 border-t-darkGray">
